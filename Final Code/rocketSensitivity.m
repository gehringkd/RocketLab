function [] = bottleRocketSensitivity(t, system, state, parameters)
...
%Find final distance x and tallest height z for each C_D
system_temp(4) = th_10;
[~,dsdt] = ode45(@(t,system_temp) rocketTrajectory(t,system_temp,state,...
...
system_temp,state,parameters_temp),t,system_temp);
p0_10_x = max(dsdt(:,6));
p0_10_z = max(dsdt(:,7));
